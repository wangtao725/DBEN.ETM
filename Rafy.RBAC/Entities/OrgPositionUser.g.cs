...
namespace Rafy.RBAC
{
    ...
    partial class OrgPositionUserRepository
    {
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new OrgPositionUser GetById(object id, EagerLoadOptions eagerLoad = null)
        {
            return base.GetById(id, eagerLoad) as OrgPositionUser;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new OrgPositionUser GetFirst(EagerLoadOptions eagerLoad = null)
        {
            return base.GetFirst(eagerLoad) as OrgPositionUser;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new OrgPositionUserList GetAll(PagingInfo paging = null, EagerLoadOptions eagerLoad = null)
        {
            return base.GetAll(paging, eagerLoad) as OrgPositionUserList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new OrgPositionUserList GetByIdList(object[] idList, EagerLoadOptions eagerLoad = null)
        {
            return base.GetByIdList(idList, eagerLoad) as OrgPositionUserList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new OrgPositionUserList GetByParentIdList(object[] parentIdList, PagingInfo paging = null, EagerLoadOptions eagerLoad = null)
        {
            return base.GetByParentIdList(parentIdList, paging, eagerLoad) as OrgPositionUserList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new OrgPositionUserList GetByParentId(object parentId, PagingInfo paging = null, EagerLoadOptions eagerLoad = null)
        {
            return base.GetByParentId(parentId, paging, eagerLoad) as OrgPositionUserList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new OrgPositionUser GetFirstBy(CommonQueryCriteria criteria)
        {
            return base.GetFirstBy(criteria) as OrgPositionUser;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new OrgPositionUserList GetByTreeParentIndex(string treeIndex, EagerLoadOptions eagerLoad = null)
        {
            return base.GetByTreeParentIndex(treeIndex, eagerLoad) as OrgPositionUserList;
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        public new OrgPositionUserList GetByTreePId(object treePId, EagerLoadOptions eagerLoad = null)
        {
            return base.GetByTreePId(treePId, eagerLoad) as OrgPositionUserList;
        }
